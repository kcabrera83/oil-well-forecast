...
|-----------|-----------|
| Time Series Framework | **Prophet** (>=1.1) |
...
### Key Libraries
- Prophet - Time series forecasting with automatic changepoints
- pmdarima - Auto ARIMA model selection
- statsmodels - Statistical models and Holt-Winters smoothing
...
├── app.py                          # FastAPI server (5 REST endpoints)
...
FastAPI + Chart.js - interactive panel with 4 sections:
